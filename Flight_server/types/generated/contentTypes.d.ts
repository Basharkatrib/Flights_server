...
export interface ApiFlightFlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::flight.flight'>;
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer: Schema.Attribute.Component<'group.grouplink', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavbarNavbar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    menu_items: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users_permissions_ser: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiTopdestTopdest extends Struct.CollectionTypeSchema {
  collectionName: 'topdests';
  info: {
    description: '';
    displayName: 'topdest';
    pluralName: 'topdests';
    singularName: 'topdest';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    trip: Schema.Attribute.Component<'trips.dests', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::topdest.topdest': ApiTopdestTopdest;
